...
class ConstellationActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Toast.makeText(applicationContext, "Constellation 입니다.", Toast.LENGTH_LONG).show()
        ...
        datePicker.init(calendar.get(Calendar.YEAR), calendar.get(Calendar.MONTH), calendar.get(Calendar.DAY_OF_MONTH), object:
            CalendarView.OnDateChangeListener, DatePicker.OnDateChangedListener {
    ...
    fun makeConstellationString(month: Int, day: Int) : String{
        val target = "${month}${String.format("%02d", day)}".toInt()
